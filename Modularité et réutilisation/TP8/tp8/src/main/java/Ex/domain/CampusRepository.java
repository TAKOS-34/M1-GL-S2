...
public interface CampusRepository extends JpaRepository<Campus, String> {
	...
	@Modifying
	@Query("UPDATE Campus c SET c.batiments = ?1 WHERE c.nomC = ?2")
	void modifieBatimentsCampus (List<Batiment> batiments, String codeC);

	@Modifying
	@Query("UPDATE Campus c SET c.ville = ?1 WHERE c.nomC = ?2")
	void modifieVilleCampus (String ville, String codeC);
